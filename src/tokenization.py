...
if __name__ == "__main__":
    text = "akAfAA1️⃣》afd, This is a 测试"
    tokenizer = SeqFullTokenizer(vocab_file="./imgfeature/mmbizwxaimagener_business/express/model/vocab.txt", do_lower_case=True)
    orig_tokens, tokens = tokenizer.tokenize(text)
    tokens = ["[CLS]"] + tokens
